...
import { withErrorHandling, ValidationError, AuthError } from '@/app/lib/error';
...
export const GET = withErrorHandling(async (request: NextRequest) => {
  ...
  let query = supabase
    .from('reservations')
    .select('*, users!customer_id(first_name, last_name, email), users!created_by(first_name, last_name, email)', { count: 'exact' });
